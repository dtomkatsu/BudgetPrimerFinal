        ...
        <section class="compare-page">
            ...
            <div class="reading-guide" id="reading-guide-box">
                ...
                <div class="reading-guide-content" id="reading-guide-content" style="display: none;">
                    ...
                    <p><strong>Capital projects often move from the Dept. of Accounting &amp; General Services (AGS) to the actual spending department.</strong> A program like Rental Housing (HMS220) can appear under both HMS and BED.</p>
