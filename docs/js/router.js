...
class Router {
    ...
    updateHeaderText(path) {
        ...
        if (footerSourceEl) {
            if (isCounties) {
                footerSourceEl.innerHTML = 'Data Source: county budget documents — Honolulu via <a href="https://data.honolulu.gov" target="_blank" rel="noopener">data.honolulu.gov</a> + capital budget ordinance; Kauaʻi capital budget ordinances; Maui and Hawaiʻi county budgets coming soon';
